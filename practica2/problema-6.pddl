...
; Problema 6: Cambio de acciones 40 unidades de recursos
...
(:objects
  ...
  vaca-1 vaca-2 - vaca
  una-piedra-1 un-junco un-adobe una-piedra-2 tres-maderas - obtener_no_animal
...
(:init (jugador-actual j1)
       ...
       (pertenece p2-1 j2) (pertenece p2-2 j2) (pertenece p2-3 j2)
       ;(recurso-carta un-jabali jabali-1) (recurso-carta un-jabali jabali-2) (recurso-carta una-vaca vaca-1)
       ;(recurso-carta una-vaca vaca-2)
       ;(recurso-carta una-oveja oveja-1) (recurso-carta una-oveja oveja-2)
       ;(recurso-carta coger-un-cereal cereal-1) (recurso-carta coger-un-cereal cereal-2)
       ;(recurso-carta jornalero comida-1) (recurso-carta jornalero comida-2) (recurso-carta tres-maderas madera-1)
       (recurso-carta tres-maderas madera-2) (recurso-carta un-adobe adobe-1) (recurso-carta un-adobe adobe-2)
       (recurso-carta un-junco junco-1) (recurso-carta un-junco junco-2)
       (recurso-carta tres-maderas madera-1) (recurso-carta tres-maderas madera-2)
      ...
      (recurso-carta una-piedra-2 piedra-1) (recurso-carta una-piedra-2 piedra-2)
       ...
       (= (n-recurso j1 piedra-1) 40) (= (n-recurso j2 piedra-2) 40)
       (= (n-recurso j1 madera-1) 40) (= (n-recurso j2 madera-2) 40) (= (n-recurso j1 adobe-1) 40) (= (n-recurso j2 adobe-2) 40)
       (= (n-recurso j1 junco-1) 40) (= (n-recurso j2 junco-2) 40) (= (n-recurso j1 cereal-1) 40) (= (n-recurso j2 cereal-2) 40)
       (= (n-recurso j1 hortaliza-1) 40) (= (n-recurso j2 hortaliza-2) 40) (= (n-recurso j1 oveja-1) 40)
       (= (n-recurso j2 oveja-2) 40) (= (n-recurso j1 jabali-1) 40) (= (n-recurso j2 jabali-2) 40)
       (= (n-recurso j1 vaca-1) 40) (= (n-recurso j2 vaca-2) 40)
       ...
       (= (jugado p1-1 j1) 0) (= (jugado p1-2 j1) 0) (= (jugado p1-3 j1) 0)
       (= (jugado p2-1 j2) 0) (= (jugado p2-2 j2) 0) (= (jugado p2-3 j2) 0)
