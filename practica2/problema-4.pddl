...
; Problema 4: Cambio de acciones
(define (problem problema-4)
(:domain agricola)
(:objects
  j1 j2 - jugador
  p1-1 p1-2 p1-3 p1-4 p2-1 p2-2 p2-3 - persona
  ...
  tres-maderas un-adobe una-piedra-1 un-junco una-piedra-2 - obtener_no_animal
...
(:init (jugador-actual j1)
       (pertenece p1-1 j1) (pertenece p1-2 j1)
       (pertenece p2-1 j2) (pertenece p2-2 j2)
       (recurso-carta un-jabali jabali-1) (recurso-carta un-jabali jabali-2)
       (recurso-carta una-vaca vaca-1) (recurso-carta una-vaca vaca-2)
       ...
       (recurso-carta un-adobe adobe-1) (recurso-carta un-adobe adobe-2)
       ...
       (is-animal oveja-1) (is-animal oveja-2)
       (is-animal jabali-1) (is-animal jabali-2)
