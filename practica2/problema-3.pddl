...
; Problema 3: Cambio de parámetros -> 2 turnos y 3 personas por jugador
(define (problem problema-1)
(:domain agricola)
(:objects
  j1 j2 - jugador
  p1-1 p1-2 p1-3 p1-4 p2-1 p2-2 p2-3 p2-4 - persona
...
(:init (jugador-actual j1)
       (pertenece p1-1 j1) (pertenece p1-2 j1) (pertenece p1-3 j1) (pertenece p1-4 j1) 
       (pertenece p2-1 j2) (pertenece p2-2 j2) (pertenece p2-3 j2) (pertenece p2-4 j2) 
       ...
       (recurso-carta un-junco junco-1) (recurso-carta un-junco junco-2) (recurso-carta pescar comida-1)
       (recurso-carta pescar comida-2) (recurso-carta una-piedra-1 piedra-1) (recurso-carta una-piedra-1 piedra-2)
       ...
       (= (n-acciones j1) 3) (= (n-acciones j2) 3)
       (= (n-recurso j1 piedra-1) 0) (= (n-recurso j2 piedra-2) 0)
       (= (n-recurso j1 madera-1) 0) (= (n-recurso j2 madera-2) 0) (= (n-recurso j1 adobe-1) 0) (= (n-recurso j2 adobe-2) 0)
       (= (n-recurso j1 junco-1) 0) (= (n-recurso j2 junco-2) 0) (= (n-recurso j1 cereal-1) 0) (= (n-recurso j2 cereal-2) 0)
